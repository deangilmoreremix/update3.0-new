...
import { X, Search, User, Building2, Mail, Phone, Check, Plus, Sparkles, UserCircle } from 'lucide-react';
                          ...
                          <div className="flex-1 min-w-0 relative">
                            <div className="flex items-center space-x-2">
                              <h4 className="font-medium text-gray-900 truncate flex items-center">
                                ...
                                {contact.lastEnrichment && (
                                  <Sparkles className="w-3 h-3 ml-1 text-purple-500" title="AI Enhanced" />
                                )}
                              </h4>
                              {selectedContactId === contact.id && (
                            ...
                            <div className="flex items-center space-x-2 mt-2">
                              <span className={`
                                ...
                                ${contact.status === 'customer' ? 'bg-green-100 text-green-700 border border-green-200' :
                              ...
                              <span className={`
                                px-2 py-0.5 text-xs rounded-full font-medium
                                ${contact.interestLevel === 'hot' ? 'bg-red-100 text-red-700 border border-red-200' :
              ...
              <div className="flex space-x-3">
                ...
                >
                  <AIResearchButton
                    ...
                    buttonText="AI Research"
                    variant="outline"
                    size="xs"
                    className="bg-purple-50 border-purple-200 text-purple-700 mr-1"
                  />
