...
import { ArrowRight, Camera, Check, CheckCheck, ChevronRight, Download, FileText, Layout, Link as ExternalLink, Palette, PencilRuler, Play, Share2, Star } from 'lucide-react';
