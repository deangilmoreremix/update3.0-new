      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            AI-powered customer relationship management platform that transforms your business workflows 
            through intelligent automation and advanced analytics.
          </p>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Leverage advanced AI to analyze customer behavior, predict trends, and automate workflows.
            </p>
          </div>
          ...
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Organize and manage your contacts with intelligent categorization and relationship tracking.
            </p>
          </div>
          ...
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Sales Pipeline</h3>
            <p className="text-gray-600 dark:text-gray-300">
              Track deals through customizable pipeline stages with automated follow-up reminders.
            </p>
          </div>
        </div>
      </div>
