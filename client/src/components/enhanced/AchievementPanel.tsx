...
import { Award, BarChart3, ChevronRight, Clock, Crown, DollarSign, Plus, Star, Target, Trophy, User, UserPlus, Zap } from 'lucide-react';
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center text-xs text-gray-500">
          <span className="flex items-center mr-3">
            ...
            ${(gamificationStats.revenueGenerated || 0).toLocaleString()}
          </span>
          <span className="flex items-center">
            <Target className="w-3 h-3 mr-1" />
            {gamificationStats.dealsCompleted || 0} deals
          </span>
        </div>
        ...
        {gamificationStats.achievements && gamificationStats.achievements.length > 0 && (
          <div className="flex items-center mt-1">
            ...
            <span className="text-xs text-gray-600">
              {gamificationStats.achievements.length} achievement{gamificationStats.achievements.length !== 1 ? 's' : ''}
            </span>
          </div>
        )}
      </div>
