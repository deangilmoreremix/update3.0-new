      ...
      <div className="absolute top-4 right-4 flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10">
        ...
        {onAnalyze && (
          <button 
            ...
            title={aiScore ? 'Re-analyze with AI' : 'Analyze with AI'}
          >
            {analyzing ? (
      ...
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-4 mt-4">
          <div className="text-center flex-1">
            ...
            <p className="text-gray-600 text-sm">{contact.title || contact.position}</p>
          ...
          <div className="flex flex-col items-center space-y-2">
            {aiScore ? (
              <div className={`h-12 w-12 rounded-full ${getScoreColor(aiScore)} text-white flex items-center justify-center font-bold text-lg shadow-lg ring-2 ring-white relative`}>
                {aiScore}
            ...
            <span className="text-xs text-gray-500 font-medium">
              {aiScore ? 'AI Score' : 'Click to Score'}
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center space-x-2 mb-4">
          <div className={`w-2 h-2 rounded-full ${interestColors[interestLevel]} animate-pulse`} />
            ...
            return (
              <div
                ...
                className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${
                  isActive 
                    ? `${interestColors[interestLevel]} shadow-lg` 
        ...
        {aiScore && (
          <div className="mb-4 p-3 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-200">
            ...
            <p className="text-xs text-gray-700">
              {aiScore >= 80 ? 'High conversion potential - prioritize for immediate follow-up.' :
               aiScore >= 60 ? 'Good engagement potential - schedule follow-up within 48 hours.' :
               aiScore >= 40 ? 'Moderate interest - nurture with valuable content.' :
