...
import { Edit, MoreHorizontal, Mail, Phone, User, UserPlus, Brain, Loader2, Sparkles, Heart, Camera, Globe, Linkedin, Twitter, Facebook, Instagram, MessageSquare } from 'lucide-react';
