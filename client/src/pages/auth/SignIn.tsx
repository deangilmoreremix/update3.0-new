    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white/70 backdrop-blur-xl border border-gray-200/50 rounded-2xl shadow-xl p-8">
          ...
          <a
            href="/auth/google"
            className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-xl shadow-sm bg-white/80 backdrop-blur-sm text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all duration-200 mb-4"
          >
          ...
          <div className="bg-blue-50/80 backdrop-blur-sm border border-blue-200 rounded-xl p-3 mb-6">
            <p className="text-xs text-blue-800">
              <strong>Google OAuth Setup:</strong> To enable Google sign-in, admin needs to configure GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET in environment variables.
            </p>
          </div>
